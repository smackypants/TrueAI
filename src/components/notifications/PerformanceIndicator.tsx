...
import { Lightning, Battery, WifiHigh, Cpu } from '@phosphor-icons/react'
          ...
          {capabilities.batteryLevel !== null && (
            ...
            >
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-2">
                  <Battery size={16} className={isLowBattery ? 'text-orange-500' : 'text-muted-foreground'} weight={capabilities.isCharging ? 'fill' : 'regular'} />
